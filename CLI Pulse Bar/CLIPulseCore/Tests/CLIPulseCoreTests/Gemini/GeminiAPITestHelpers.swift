...
// Tests/CodexBarTests/GeminiAPITestHelpers.swift (MIT, © Peter
// Steinberger) — test fixture builders for the Gemini probe ports.
// See GeminiStatusProbe.swift for the full MIT notice.
